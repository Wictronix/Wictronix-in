      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid md:grid-cols-2 gap-6 items-stretch max-w-5xl mx-auto">
          ...
          >
            ...
            <button className="relative z-10 flex items-center space-x-3 text-lg font-bold group-hover:translate-x-3 transition-transform duration-500 w-fit">
          ...
          >
            ...
            <button className="relative z-10 flex items-center space-x-3 text-lg font-bold group-hover:text-accent group-hover:translate-x-3 transition-all duration-500 w-fit">
